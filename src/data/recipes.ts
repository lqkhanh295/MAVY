...
export const FEATURED_RECIPES: Recipe[] = [
  ...
  {
    id: "muc-hap-gung-sa",
    title: "Mực Trứng Hấp Gừng Sả Lá Chanh",
    category: "muc",
    prepTime: "10 phút",
    cookTime: "12 phút",
    difficulty: "Dễ",
    servings: "2 - 3 người",
    flavorProfile: "Thanh mát, béo bùi trứng mực, ngọt thanh nguyên bản",
    description:
      "Phương pháp hấp giữ trọn 100% vị ngọt đậm và độ béo bùi của túi trứng mực MAVY, kết hợp hương thơm ấm nồng của sả gừng giúp giải ngấy tuyệt vời.",
    ingredients: [
      { name: "Mực Trứng Đông Lạnh MAVY", amount: "500g (size VIP đầy trứng)", isMain: true },
    ...
    steps: [
      "Mực trứng rã đông tự nhiên trong nước lạnh 5 phút, giữ nguyên vẹn túi trứng béo bùi bên trong.",
      "Lót một lớp sả đập dập và gừng thái sợi dưới đáy đĩa hấp.",
      "Đặt mực trứng lên trên, rải thêm gừng, ớt lát và lá chanh vò nhẹ lên bề mặt.",
      "Đun nước sôi bùng rồi cho đĩa mực vào xửng hấp cách thủy trong 8 - 10 phút.",
      "Tắt bếp, gắp mực ra đĩa, để nguyên con hoặc cắt khoanh vừa ăn và chấm cùng nước mắm gừng ớt chua cay đậm đà.",
    ],
    chefTips:
      "Chỉ hấp mực đúng 8-10 phút khi nước đã sôi sùng sục để mực chín tới giòn ngọt, túi trứng bên trong chín bùi mà không bị vỡ.",
  },
  {
    id: "lau-hai-san-mavy",
    ...
    difficulty: "Trung bình",
    servings: "4 - 6 người",
    flavorProfile: "Chua cay đậm đà, nước dùng ngọt thanh từ vỏ cua tôm",
    description:
      "Nồi lẩu hải sản tụ hội đầy đủ bộ 3 Cua Gạch - Tôm Sú Đông Lạnh - Mực Trứng Đông Lạnh trong làn nước dùng Tomyum Thái chua cay kích thích vị giác.",
    ingredients: [
      { name: "Cua Gạch MAVY", amount: "1 con (400g - 500g)", isMain: true },
      { name: "Tôm Sú Đông Lạnh MAVY", amount: "300g (size VIP)", isMain: true },
      { name: "Mực Trứng Đông Lạnh MAVY", amount: "300g", isMain: true },
